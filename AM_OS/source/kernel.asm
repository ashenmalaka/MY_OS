;AMOS --- The AM Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE AMOS_VER '1.0.0'	 ;OS version number
	%DEFINE AMOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '----- Welcome to AMOS -----', 0
	os_version_msg		db 'Version ', AMOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', AMOS_VER, 0

	dialog_string_1		db 'Welcome to AM Operating System', 0
